class Calculator {
    constructor(prevOperand, currOperand) {
        this.prevOperandTextElement = prevOperand;
        this.currOperandTextElement = currOperand;
        this.clear();
    }
    ...
    updateDisplay() {
        this.currOperandTextElement.innerText = this.formatNumber(this.currOperand);
        if (this.operation != null) {
            this.prevOperandTextElement.innerText =
                this.formatNumber(this.prevOperand) + " " + this.operation;
        } else {
            this.prevOperandTextElement.innerText = this.formatNumber(this.prevOperand);
        }
    }
}
